...
import '../Professional Doctor/category/category_screen.dart';
        ...
        body:  Container(
          ...
          child:Padding(
           padding:  EdgeInsets.only(top: 120.h,left: 30.w,right: 30.w),
            ...
            child: const LoginOptionWidget(text: 'Users', color: AppColors.browncolor, title: 'User', subtitle: 'Tap to Continue as a User.', image: 'assets/image62.png',)),
            GestureDetector(
