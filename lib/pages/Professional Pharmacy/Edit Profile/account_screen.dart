  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Account",style: TextStyle(color: Colors.black,fontSize: 18.sp,fontWeight: FontWeight.w600),),
        centerTitle: true,
        actions: [IconButton(onPressed: (){
          Get.to(PharmacyEditProfile(),transition: Transition.fade);
    ...
    body: SingleChildScrollView(
      ...
      // ),
        ...
        Text("CareFirst",style: TextStyle(color: Colors.black,fontSize: 14.sp,fontWeight: FontWeight.w400),),
                  SizedBox(height: 15.h,),
