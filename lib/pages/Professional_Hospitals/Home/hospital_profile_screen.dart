                        ...
                        isEdit?Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 10.h,),
                              Text("Add Doctors",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w400,fontSize: 10.sp),)
                            ],
                          ),
                        ):const SizedBox(),
                        SizedBox(
                      ...
                      child:Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children:  [
                                const Icon(Icons.image,color: AppColors.secondarycolor,size: 20,),
                                const Spacer(),
                                Container(
                                  height: 30.h,
                                  width: 80.w,
