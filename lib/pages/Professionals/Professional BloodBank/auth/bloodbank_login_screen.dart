...
import '../home/bloodbank_home_screen.dart';



class BloodBankLoginScreen extends StatelessWidget {
            ...
            Container(
                ...
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image: AssetImage("assets/image72.png"),
                        fit: BoxFit.fill)),
                child: Padding(
                    ...
                    child: Column(
                        ...
                        children:  [
                          ...
                          CustomButton(text: 'Login', onTap: () {Get.to(BloodBankHomeScreen()); }, gradient: AppColors.Gardient(),),
                          SizedBox(height: 20.h,),
                          const TextWidget(title: 'Don\t have an Account?', subtitle: 'Create',)
