...
import 'package:journey_of_you/pages/Professionals/Professional%20Pharmacy/Pharmacy%20Detail/pharmacy_product_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Add Products",style: TextStyle(color:Overseer.theme?AppColors.lightcolor: Colors.black,fontSize: 18.sp,fontWeight: FontWeight.w600),),
        centerTitle: true,
      ),
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 40.h,),
              CustomButton(text: "Add", onTap: (){Get.to(const PharmacyProductScreen(),transition: Transition.fade);}, gradient:Overseer.theme?AppColors.GardientD1(): AppColors.Gardient(),)
