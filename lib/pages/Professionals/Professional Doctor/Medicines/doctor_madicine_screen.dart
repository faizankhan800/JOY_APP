...
import 'doctor_product_screen.dart';
ThemeManager _themeManager = ThemeManager();

class DoctorMedicineScreen extends StatefulWidget {
  const DoctorMedicineScreen({Key? key}) : super(key: key);

  @override
  State<DoctorMedicineScreen> createState() => _DoctorMedicineScreenState();
}

class _DoctorMedicineScreenState extends State<DoctorMedicineScreen> {
  @override
                    ...
                    SizedBox(
                      ...
                      child: GridView.builder(
                        ...
                        return GestureDetector(
                          onTap: (){ Get.to(DoctorProductScreen());
                          }
                          ,
                          child: Container(
