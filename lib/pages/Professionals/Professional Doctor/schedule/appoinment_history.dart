  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Appointment History",style: TextStyle(color: Overseer.theme?Colors.white:Colors.black,fontSize: 18.sp,fontWeight: FontWeight.w600),),
        centerTitle: true,
      ),
      body: Padding(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: Overseer.theme?AppColors.dimcolor:Colors.grey)
              ),
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Arshad Khan came this Monday with a\n Distinctive behavioral improvement,\n we talked about his new relationship with a girl\n in his  neighbourhood. ",
                      style: TextStyle(color: Overseer.theme?Colors.white:AppColors.blackcolor,fontSize: 14.sp,fontWeight: FontWeight.w400),
                    ),
                    SizedBox(height: 5.h,),
                    Row(
