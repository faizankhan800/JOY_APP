...
import '../../../Users/chat/chat_screen.dart';
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  child:  Center(
                                    child:  Icon(Icons.edit,color: Overseer.theme?Colors.white:Colors.black,size: 15,),
                                  ),
                                ),
                              )
                            ],
                           ...
                           child: Padding(
                             ...
                             child: Column(
                               ...
                               Text(" Appointment",
                                 ...
                                 Text(" Ongoing",
                                   style: TextStyle(color: Overseer.theme?Colors.white:AppColors.blackcolor,fontSize: 16.sp,fontWeight: FontWeight.w500),),
                                 SizedBox(height: 15.h,),
                                 Container(
                                   ...
                                   child: Row(
                                     children: [
                                       ...
                                       Text("Started 54m ago\n Aidda Bugg.",
                                         style: TextStyle(color: Overseer.theme?Colors.white:Colors.black,fontSize: 14.sp,fontWeight: FontWeight.w400),)
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            child:Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                              children: [
                                                Text("Ali Hamza",style: TextStyle(color: Overseer.theme?Colors.white:AppColors.blackcolor,fontSize: 14.sp,fontWeight: FontWeight.w400),),
                                                CircleAvatar(radius: 10.r,
                                                  backgroundColor:Overseer.theme?AppColors.browncolor1:AppColors.browncolor,
