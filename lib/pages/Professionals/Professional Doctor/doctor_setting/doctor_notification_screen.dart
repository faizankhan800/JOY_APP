...
class DoctorNotificationSetting extends StatelessWidget {
  const DoctorNotificationSetting({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Notification",style: TextStyle(color: Overseer.theme?Colors.white:Colors.black,fontSize: 18.sp,fontWeight: FontWeight.w600),),
        centerTitle: true,
      ),
      body: SafeArea(
        child: Padding(
