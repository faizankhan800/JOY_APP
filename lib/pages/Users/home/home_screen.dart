      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
               AppBarWidget(subtitle: "Find people with same Condition", title: "Hello Nouman"),
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        const Spacer(),
                         CircleAvatar(backgroundColor:AppColors.browncolor,child: Icon(Icons.person_add_alt,size: 20,),)
                      ],
                    ),
                  );
                }),
