  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Friend Request",style: TextStyle(color: Overseer.theme?Colors.white:AppColors.blackcolor,fontSize: 18.sp,fontWeight: FontWeight.w600),),
                  ...
                  return Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        SizedBox(width: 8.w,),
                        CircleAvatar(backgroundColor:AppColors.checkcolor,child: Icon(Icons.check,size: 15,color: Colors.white,),radius: 15.r,),
